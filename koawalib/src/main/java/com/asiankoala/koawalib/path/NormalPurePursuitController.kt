...
object NormalPurePursuitController {
    fun goToPosition(
            currPose: Pose,
     ...
     */
    fun clipToPath(waypoints: List<NormalWaypoint>, position: Point): IndexPoint {
    ...
    fun calcLookahead(waypoints: List<NormalWaypoint>, currPose: Pose, followDistance: Double): NormalWaypoint {
