package neil.koawalib.command

import neil.koawalib.command.commands.Command
import neil.koawalib.command.commands.InfiniteCommand
import neil.koawalib.command.commands.Watchdog
import neil.koawalib.command.group.CommandGroupBase
...
object CommandScheduler {
    ...
    private val allLists = listOf(mInitActions, mExecuteActions,
    ...
    private fun schedule(command: Command) {
        ...
        if(runningOpMode && (mDisabled || (!command.runsWhenDisabled && mOpMode.disabled) ||
