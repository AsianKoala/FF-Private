...
object Odometry : Subsystem() {
    private val leftServo = WraithServo("leftRetract")
    private val rightServo = WraithServo("rightRetract")
    private val auxServo = WraithServo("auxRetract")
    ...
    override fun updateDashboard(debugging: Boolean) {
        WraithDashboard["current position"] = currentPosition
    }
}