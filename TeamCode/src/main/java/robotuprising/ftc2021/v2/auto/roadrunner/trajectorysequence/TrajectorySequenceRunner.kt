...
import robotuprising.ftc2021.v2.auto.roadrunner.util.DashboardUtil.drawPoseHistory
import robotuprising.ftc2021.v2.auto.roadrunner.util.DashboardUtil.drawRobot
import robotuprising.ftc2021.v2.auto.roadrunner.util.DashboardUtil.drawSampledPath
import java.util.*
    ...
    fun update(poseEstimate: Pose2d, poseVelocity: Pose2d?): DriveSignal? {
        ...
        if (currentTrajectorySequence != null) {
            ...
            if (isNewTransition) {
                ...
                remainingMarkers.sortWith(Comparator { (t1), (t2) -> java.lang.Double.compare(t1, t2) })
            }
