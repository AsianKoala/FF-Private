...
import robotuprising.lib.movement.odometry.Speedometer
import robotuprising.ftc2021.control.localization.ThreeWheelOdometry
import robotuprising.ftc2021.hardware.BaseRobot
import robotuprising.ftc2021.opmodes.DriveTrain
...
@Config
@Deprecated("@see Akemi")
abstract class OldAzusa(dataPacket: OpModePacket) : BaseRobot(dataPacket) {
