...
class HubVisionTest : OpMode() {
    ...
    lateinit var pipeline: HubDetectionPipeline
    ...
    * */
    class HubDetectionPipeline : OpenCvPipeline() {
...
//            region1_Cb = Cb.submat(Rect(four_ring_pointA, four_ring_pointB))
        ...
        companion object {
            ...
            const val REC_WIDTH = 100
            const val REC_HEIGHT = 100
        }
    }
}
