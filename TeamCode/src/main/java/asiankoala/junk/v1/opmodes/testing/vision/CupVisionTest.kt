package asiankoala.junk.v1.opmodes.testing.vision
...
//                if (DISPLAY) Imgproc.drawContours(output, contours, -1, DISPLAY_COLOR)
                ...
                if (DISPLAY) {
                    ...
                    Imgproc.putText(
                        output,
                        "Area: " + getRectArea().toString() + " Midpoint: " + getRectMidpointXY().x.toString() + " , " +
                            getRectMidpointXY().y.toString() + " Selection: " + get(),
                        Point(20.0, (input.height() - 20.0).toDouble()),
